...
template <typename C>
void Grafo<C>::agregarVertice(int vertice)
{
    map<int, C> arcos;
...
template <typename C>
void Grafo<C>::modificarCostoArco(int origen, int destino, const C &costo)
{
...
template <typename C>
void Grafo<C>::eliminarArco(int origen, int destino)
{
